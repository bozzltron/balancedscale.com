...
export default function PressReleasePage() {
  ...
  return (
    <>
      <StandardMetadata
        title={`${pressRelease.title} | Balanced Scale Media`}
        description={pressRelease.excerpt}
        url={`https://balancedscale.com/press/${pressRelease.slug}/`}
        type="article"
        keywords={`${pressRelease.tags.join(', ')}, press release, Balanced Scale Media, Austin music`}
        author="Balanced Scale Media"
      ...
      <div class="min-h-screen bg-bg-primary text-text-primary py-12">
        ...
        <main id="main-content" class="container mx-auto max-w-4xl px-4" role="main">
          ...
          <header class="mb-8 text-center">
            ...
            <h1 class="text-4xl md:text-5xl font-serif font-bold mb-4">{pressRelease.title}</h1>
