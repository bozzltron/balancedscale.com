...
export default function Press() {
  ...
  return (
    <>
      <StandardMetadata
        title="Press | Balanced Scale Media"
        description="Latest news and press releases from Balanced Scale Media. Stay updated on artist signings, new releases, and label announcements."
        url="https://www.balancedscale.com/press"
        type="website"
        keywords="press releases, music news, artist announcements, record label news"
      />
        ...
        >
          <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-12 text-center">
              ...
              >
                Latest news and announcements from Balanced Scale Media.
              </p>
            </div>
