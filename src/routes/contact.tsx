...
export default function Contact() {
  return (
    <>
      <StandardMetadata
        title="Contact | Balanced Scale Media"
        description="Get in touch with Balanced Scale Media. Press and media inquiries welcome."
        url="https://www.balancedscale.com/contact"
        type="website"
        keywords="contact, press inquiries, media contact, record label contact"
      />
          ...
          <div class="max-w-3xl mx-auto">
            ...
            <div class="space-y-8">
              ...
              >
                ...
                <a 
                  href="mailto:promo@balancedscale.com"
