...
export default function Artists() {
  ...
  return (
    <>
      <StandardMetadata
        title="Artists | Balanced Scale Media"
        description="Meet the innovative artists on the Balanced Scale Media roster. Independent musicians creating meaningful work across multiple genres."
        url="https://www.balancedscale.com/artists"
        type="website"
        keywords="artists, musicians, indie artists, record label roster"
      />
